...
<div class="wrap">
  ...
  <div class="ask">
    ...
    <p><b>Первое.</b> Где граница проходит не там — назови номер сектора и улицу, по которой
      должна идти линия.</p>
    <p><b>Второе, важнее.</b> В секторы попало ${inCount} объектов, вне нарезки осталось
      ${outside.length}. Это примерно ${days} рабочих дней на пятерых менеджеров — потом
      адреса в секторах кончатся. Резать Москву дальше или разрешить брать объекты вне
      секторов, когда десяти не набирается?</p>
    <p><b>Третье.</b> Новая Москва (Коммунарка, Калужское шоссе, Троицк) и Зеленоград —
      формально Москва, но за МКАД и вне всех секторов, около 57 объектов. Удалять, как
      Подмосковье, или оставить?</p>
  </div>
</div>
<script>
